  ...
  Future<void> _procesarPago() async {
    ...
    try {
      ...
      if (initPoint != null && initPoint.isNotEmpty && !initPoint.contains('localhost')) {
        ...
        // Flujo de prueba/simulado cuando se ejecuta en desarrollo local
        _cartService.vaciarCarrito();
        ...
        await showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: Text(
              'Tu pedido #${idFactura ?? DateTime.now().millisecondsSinceEpoch} fue creado satisfactoriamente por un total de ${_formatearPrecio(total)}.\n\n(Simulación de pasarela de pago completada)',
              textAlign: TextAlign.center,
              style: const TextStyle(fontSize: 14, color: AppTheme.textSecondary),
            ),
            actions: [
